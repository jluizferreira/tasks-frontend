...
export default function App() {
  ...
  useEffect(() => {
    fetch("https://tasks-api-production-6b05.up.railway.app/api/auth/me", { credentials: "include" })
      .then((r) => r.json())
      .then((data) => {
  ...
  const handleLogout = async () => {
    await fetch("https://tasks-api-production-6b05.up.railway.app/api/auth/logout", {
      method: "POST",
      credentials: "include",
    });
    setUser(null);
